# Développement efficace avec Rstudio
...
![Illustration de structure d'un projet R](./pics/02_rstudio/03a_project_organization1.png){width=80%}


On peut accéder aux derniers projets ouverts avec le raccourci en haut à droite:

![Raccourci pour accéder aux derniers projets](./pics/02_rstudio/03a_project_organization2.png){width=80%}
...
![Installer facilement de nouveaux addins](./pics/02_rstudio/06b_addins.png){width=100%}
