...
(cf. [section précédente](#orgagit)) /*renvoi au chapitre 6 et non à la section précédente*/, cela obligera l'équipe
...
La CNIL fournit des conseils aux développeurs pour compléter ces bonnes pratiques ([lien](https://linpricnil.github.io/Guide-RGPD-du-developpeur/)) /*lien ne fonctionne pas*/.
...
* des supports du SNDI sur les [bases de `GIT`](http://formation-git-sndi-lille.pages.innovation.insee.eu/cours/#/) /*lien ne fonctionne pas*/
