...
* en commençant par mettre à jour sa copie locale régulièrement via `r with_def("pull")` ou `r with_def("fetch")`, voire dès qu'on commence /* OU a commencé*/ à travailler sur un projet
