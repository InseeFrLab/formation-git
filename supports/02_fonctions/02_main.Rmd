...
Lorsqu'on a un code fonctionnel et qu'on le partage, la source la plus commune d'erreur lorsque quelqu'un d'autre fait tourner ce code est que les environnements ne coïncident pas. Pour assurer un code fonctionnel lors d'un partage, il est important de comprendre la manière dont `R` gère les objets, environnements et dépendances. 
