...
## Recommandation pour faire GIT en local
...
##Gitlab, plateforme de partage de code 
...
## Pratique de GitLab au quotidien
...
### Usages de `git` dans la communauté R
...
C'est la responsabilité des mainteneurs : seuls les mainteneurs peuvent merger dans master.  
Il leur appartient de veiller à la bonne qualité des merge requests.
