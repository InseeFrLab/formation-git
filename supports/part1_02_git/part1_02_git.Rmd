...
* enregister l'historique des modifications d'un ensemble de fichiers 
...
Que ce soit au sein d'un travail collaboratif en équipe ou sur ses propres projets indivduels, notre temps est consacré à la programmation réellement utile. L'organisation du traval est efficace grâce :
* aux améliorations rapides des codes
* au partage efficace des tâches
* à la recherche puissante des erreurs
* à un archivage géré automatiquement avec des méta-donées
...
Les deux langage de gestion de version les plus répandus sont GIT et SVN. L'Insee a utilisé SVN pendant un temps mais privilégie GIT maintenant.
...
Centralisé (SVN) vs distribué (GIT) : avantage de GIT sont la sécurité (dépôts copiés localement) et la  rapidité
...
* staging area puis commit : sélection et envoi des modifications
