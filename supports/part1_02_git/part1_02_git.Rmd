...
## Exercice 3 : Fusionner les travaux avec des `Merge Requests`
...
a) Ouvrir des merge requests 
créer une MR proprement avec GitLab (indications)

b) contribuer aux merge requests
Choisissez une autre MR et contribuez-y via GitLab.

c) Fusionner les merge requests
...
## Exercice 4 : Résoudre les conflits, c'est facile.
