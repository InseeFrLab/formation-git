...
pas les données .csv par la production : html pdf

Conseils de la Cnil : https://linpricnil.github.io/Guide-RGPD-du-developpeur/ 

* Sauvegarder une version figée : git tag

* Retour en arrière dans l'historique

* `git blame` : Qui a modifié en dernier une ligne donné dans un fichier donné 


Rebasage : Réécriture de l'historique (usage non recommandé pour un usage non approfondi)
...
Des ressources externes : un [livre en français](https://git-scm.com/book/fr/v2) accessible en ligne et la [documentation en ligne](https://git-scm.com/doc) de `GIT`.
...
créer un compte sur la plateforme innovation/ Accéder à Gitlab

Générer une clé SSH

Ajout de la clé SSH sous Gitlab

https://git.stable.innovation.insee.eu/animation-ateliers-r-dsds/atelier-1/wikis/Utiliser-Git-et-Gitlab-%C3%A0-l'Insee 
