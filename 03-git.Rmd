...
Même lorsqu'on travaille tout seul, on collabore avec un *moi* futur qui peut ne plus se souvenir de la modification des fichiers. 
...
c'est l'espace pour gérer des fusions de branches. Normalement, on arrive dans un deuxième temps dans cet espace:
...
équipe dont personne n'aurait d'expérience avec `Git`. Grâce aux fonctionalités
