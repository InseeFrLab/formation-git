...
![](./pics/04/markdowntypes_sorties.png)
...
* la possibilité de commenter l'ensemble du document, ce qui
    ...
    * pour commenter : 
        * Dans le texte, pour activer/désactiver un commentaire c'est facile : **ctl + Maj + c**
            * ![](./pics/04/markdownCommentaire.png)
...
![](./pics/04/markdowncrea_premier_fic.png)
...
![](./pics/04/markdowninserer_lien_nom.png)

une adresse utile [ici](https://rmarkdown.rstudio.com)

#### Insérer une image

![](./pics/04/markdowninserer_img.png)

![](./pics/04/markdownCaptureInsee.png)

#### Exercice 1

**Créer un fichier R Markdown produisant la sortie suivante :** 
![](./pics/04/markdowncapture_exo1.png)
...
![](./pics/04/markdowninserer Rsimple.png)
...
![](./pics/04/markdowncheat sheet Rmarkdown.png)
